...
public interface BookingRepository extends JpaRepository<Booking, Integer> {
	...
	public List<Booking> findAllUserBooking(@Param("user") User user,@Param("booking_from_date") LocalDateTime booking_from_date, @Param("booking_to_date") LocalDateTime booking_to_date);
	...
	public List<Booking> findAllCarBooking(@Param("car") Car car,@Param("booking_from_date") LocalDateTime booking_from_date, @Param("booking_to_date") LocalDateTime booking_to_date);
}
